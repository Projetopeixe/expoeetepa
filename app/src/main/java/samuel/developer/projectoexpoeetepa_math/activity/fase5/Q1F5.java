package samuel.developer.projectoexpoeetepa_math.activity.fase5;
...
import samuel.developer.projectoexpoeetepa_math.activity.fase6.Q2F6;

public class Q1F5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q1_f5);
        carregarComponetes();
        carregamentoTempo();
    ...
    public void questaoCerta(){
        ...
        builder.setPositiveButton("Próxima Questão", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(getApplicationContext(), Q2F5.class);
