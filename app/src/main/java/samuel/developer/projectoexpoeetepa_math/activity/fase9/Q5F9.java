package samuel.developer.projectoexpoeetepa_math.activity.fase9;
...
public class Q5F9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q5_f9);
        carregarComponentes();
        carregamentoTempo();
    ...
    public void faseConcluida(){
        ...
        builder.setCancelable(false);
        builder.setMessage("Parabéns! Você concluiu a nona fase e desbloqueou a décima!");
        builder.setPositiveButton("Voltar ao menu principal", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                finish();
