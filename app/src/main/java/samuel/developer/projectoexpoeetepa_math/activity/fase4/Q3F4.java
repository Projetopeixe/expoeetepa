...
public class Q3F4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q3_f4);
        carregarComponentes();
        carregamentoTempo();
    ...
    public void questaoCerta(){
        ...
        builder.setPositiveButton("Próxima Questão!", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(getApplicationContext(), Q4F4.class);
    ...
    public void tempoEsgotado(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Acabou seu tempo, negah!");
