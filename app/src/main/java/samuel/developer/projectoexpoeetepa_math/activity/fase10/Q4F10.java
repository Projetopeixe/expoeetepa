package samuel.developer.projectoexpoeetepa_math.activity.fase10;
...
public class Q4F10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q4_f10);
        carregarComponentes();
        carregamentoTempo();
    ...
    public void questaoCerta(){
        ...
        builder.setPositiveButton("Próxima Questão", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(getApplicationContext(), Q5F10.class);
