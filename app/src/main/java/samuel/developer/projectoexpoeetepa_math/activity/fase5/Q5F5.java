...
public class Q5F5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q5_f5);
        carregarComponentes();
        carregamentoTempo();
    ...
    public void desbloquearFase(){
        ...
        banco.execSQL("UPDATE fases SET fase6 = 1");
    }
    ...
    public void faseConcluida(){
        ...
        builder.setCancelable(false);
        builder.setMessage("Parabéns! Você concluiu a quinta fase e desbloqueou a sexta!");
        builder.setPositiveButton("Voltar ao menu principal", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                finish();
